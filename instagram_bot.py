...
if os.path.exists(MODEL_PATH):
    print("Loading AI Model Brain for Instagram...")
...
def home():
    return "📸 AI Stock Predictor Bot is running! 📈 Visit /instagram for the Twilio Instagram webhook."

@app.route("/instagram", methods=['GET', 'POST'])
def instagram_reply():
    if request.method == 'GET':
        return "📸 AI Stock Predictor Bot is running for Instagram! 📈"
    ...
    try:
        ...
        msg = (
            f"📸 *AI Stock Predictor (Instagram)*\n"
            f"━━━━━━━━━━━━━━━━━━\n"
            f"📈 *Stock:* {ticker}\n"
